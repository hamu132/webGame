...
class Typing{
    constructor(canvas,ctx){
        ...
        this.hiraganas = [
            ...
            "おやつ", "うし", "さかな", "ねこ", "とり", "しか", "きつね", "たぬき", "ラクダ", "ペンギン",
            "アリ", "くも", "トンボ", "カブトムシ", "セミ", "ハチ", "てんとうむし", "いもむし",
            "かみなり", "たいふう", "なだれ", "つなみ", "ゆき", "あらし", "かえで", "もみじ", "ひまわり", "たんぽぽ",
            "でんち", "まど", "かべ", "いす", "つくえ", "ほんだな", "けしごむ", "えんぴつ",
            "はし", "なべ", "やかん", "まないた", "れいぞうこ", "せんたくき", "そうじき","タツノオトシゴ",
            "パソコン","メイドインアビス","あいですよナナチ","プログラミング","ぱいそん","すもももももももものうち",
            "アソパソマソ","どしがたい","ひぐらしのなくころに","スクリプト","マジでひまです","ちいさいもじはつかえません",
            "タイピング","あいあいがさ","ああああああああああ","よろしくおねがいします",
            "もんだいつくるのむずかしいよね","じんこうちのうにおまかせ","おすすめのアニメをおしえて",
            "ほんとうにごめんなさい","もうこのぐらいでいいですか","あとはキミにまかせました",
            "すたべいおをやりたいですよね","がんばりたい","おやおやおやおやおやおや",
            "アビスはのろいだけをあたえているのか","あとではだかづりだよ","ぐへへ",
            "マジでそろそろおわりでいいですか","すしだはいいサイトですよね","かいはつきかんははつかです",
            "かわいいかどうかがたいせつなんだ","さようなら"
          ];
        this.canvas = canvas;
        this.ctx = ctx;
        this.createText();
